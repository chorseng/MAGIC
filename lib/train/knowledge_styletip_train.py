...
from config import KnowledgeStyletipTrainConfig, GlobalConfig
from config.model_config import (MemoryConfig,
                                 StyletipMemoryConfig,
                                 GraphEncoderConfig,
                                 KnowledgeTextDecoderConfig)
from constant import KNOWLEDGE_STYLETIP_SUBTASK
from dataset import Dataset
from dataset.knowledge_data import StyleTipsData
from lib import encode_context
from lib.loss import text_loss
from lib.valid import knowledge_styletip_valid
from lib.test import knowledge_styletip_test
from model import TextDecoder, ToHidden, GraphEncoder, Memory
from model import TextEncoder, ImageEncoder, ContextEncoder


def knowledge_styletip_train(
    ...
    for epoch_id in range(epoch_id,
        ...
        for batch_id, train_data in enumerate(train_data_loader):
            ...
            encode_knowledge_func = partial(styletip_memory,
                                            knowledge_entry)
            ...
            if (batch_id + 1) % KnowledgeStyletipTrainConfig.valid_freq == 0:
                ...
                if min_valid_loss is None or valid_loss < min_valid_loss:
                    ...
                    if bad_loss_cnt > KnowledgeStyletipTrainConfig.patience:
                        knowledge_styletip_test(context_text_encoder,
                                                context_image_encoder,
                                                context_encoder,
                                                to_hidden,
                                                graph_encoder,
